 ...
 */
/* line 1466 :
 * Origin: E.nick.length < 3	Edited: E.nick.length < 1
 * line 1170 & line 1497 :
 * Origin: "Anonymous"	Edited: "匿名"
 * line 3545
 * Origin: nick: "昵称"	   Edited: nick: "昵称（QQ号）",
 * line 1692
 * Origin:	url: “//valine.api.ioliu.cn/getqqinfo”  Edited: url: "https://api.usuuu.com/qq/",
 */
! function (e, t) {
	...
	return function (e) {
			...
			var z = e.$el.find(".vsubmit"),
				...
				U = function () {
					...
					for (var o in E)
						...
						"匿名" != E.nick && y.default.store.set(h.MetaCacheKey, {
							nick: E.nick,
							link: E.link,
							mail: E.mail
						});
		...
		*/
		...
		e.exports = {
			...
			mail: "E-Mail",
			link: "Website(http://)",
			nickFail: "NickName cannot be less than 1 bytes.",
		...
		e.exports = {
			...
			mail: "メールアドレス",
			link: "サイト(http://)",
			nickFail: "1バイト以上のニックネームをご入力ください.",
